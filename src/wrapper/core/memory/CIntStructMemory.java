 ...
 * @param <T>
 */
public class CIntStructMemory<T extends IntStruct> extends CMemory<T> {
    StructIntArray<T> array;
    
    public CIntStructMemory(CCommandQueue queue, cl_mem memory, Class<T> clazz, StructIntArray array, Buffer buffer, Pointer pointer, long cl_size) {
