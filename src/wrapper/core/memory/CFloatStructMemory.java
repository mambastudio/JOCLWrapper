 ...
 * @param <T>
 */
public class CFloatStructMemory<T extends FloatStruct> extends CMemory<T> {
    
    StructFloatArray<T> array;
    
    public CFloatStructMemory(CCommandQueue queue, cl_mem memory, Class<T> clazz, StructFloatArray array, Buffer buffer, Pointer pointer, long cl_size) {
