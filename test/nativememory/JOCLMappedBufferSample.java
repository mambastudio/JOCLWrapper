...
public class JOCLMappedBufferSample
{
    ...
    public static void main(String args[])
    {
        ...
        int n = 10;
        NativeFloat srcArrayA = new NativeFloat(n);
        NativeFloat srcArrayB = new NativeFloat(n);
        NativeFloat dstArray = new NativeFloat(n);
        for (int i=0; i<n; i++)
        {
            srcArrayA.set(i, i);
            srcArrayB.set(i, i);
        ...
        cl_mem srcMemA = clCreateBuffer(context, 
            ...
            Sizeof.cl_float * n, Pointer.to(srcArrayA.getDirectByteBufferPoint()), null);
        cl_mem srcMemB = clCreateBuffer(context, 
            CL_MEM_READ_ONLY | CL_MEM_COPY_HOST_PTR,
            Sizeof.cl_float * n, Pointer.to(srcArrayB.getDirectByteBufferPoint()), null);
        ...
        CL.clEnqueueWriteBuffer(commandQueue, srcMemA, true, 0, n * Sizeof.cl_float, Pointer.to(srcArrayA.getDirectByteBufferPoint()), 0, null, null);
        ...
        clEnqueueReadBuffer(commandQueue, dstMem, CL_TRUE, 0,
            n * Sizeof.cl_float, Pointer.to(dstArray.getDirectByteBufferPoint()), 0, null, null);
        ...
        for (int i=0; i<n; i++)
        {
            float x = dstArray.get(i);
            float y = srcArrayA.get(i) * srcArrayB.get(i);
        ...
        if (n <= 1000)
        {
            System.out.println("Result: "+dstArray);
        }
