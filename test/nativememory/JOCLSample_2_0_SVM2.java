 ...
 */
public class JOCLSample_2_0_SVM2
{
    /**
    ...
    public static void main(String[] args)
    {
        ...
        Pointer srcA = Pointer.to(srcArrayA.getDirectByteBufferPoint());
        Pointer srcB = Pointer.to(srcArrayB.getDirectByteBufferPoint());
        ...
        Pointer dst = Pointer.to(dstArray.getDirectByteBufferPoint());
        ...
        for (int i=0; i<n; i++)
        {
            ...
            float y = 
                (srcArrayA.get(i)+srcArrayA.get(i) * 
                (srcArrayB.get(i)+srcArrayB.get(i)));
        ...
        if (n <= 100)
        {
            System.out.println("Result: "+dstArray.toString());
        }
