...
public class SVMMemoryManager {
    ...
    public static void fillOne(SVMNative<Int32> cmem)
    {
        Objects.requireNonNull(configuration, "opencl configuration is null");
        Objects.requireNonNull(cmem, "memory is null");
        ...
        SVMNative<Long64> clength = configuration.createSVMValue(new Long64(cmem.size()));
