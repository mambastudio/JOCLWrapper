...
import svm.*;
import org.jocl.CL;
import static org.jocl.CL.CL_DEVICE_IMAGE_MAX_ARRAY_SIZE;
 ...
 * @author user
 */
public class DetectImageCapabilities {
    public static void main(String[] args)
    {
        ...
        for (cl_platform_id platform : platforms)
        {
            ...
            for (cl_device_id currentDevice : allDevices)
            {
                ...
                int capabilities[] = { 0 };
                clGetDeviceInfo(currentDevice, CL_DEVICE_IMAGE_MAX_ARRAY_SIZE,
                    Sizeof.cl_long, Pointer.to(capabilities), null);
                System.out.println("Images supported: "+Arrays.toString(capabilities));
            }
        }
    }
