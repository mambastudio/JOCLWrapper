...
public class DeviceQuery {
    ...
    public DeviceQuery(ArrayList<CPlatform> platforms)
    {
    ...
    {        
        System.out.println("Number of platforms: "+CPlatform.getNumberOfPlatforms());
        ...
        platforms.stream().map(platform -> { 
            ...
            int numDevices = platform.getDeviceNo();
            System.out.println("Number of devices in platform "+platformName+": "+numDevices);
            // CL_PLATFORM_VERSION
            String platformVersion = getString(platform.getId(), CL_PLATFORM_VERSION);
            System.out.printf("CL_PLATFORM_VERSION: \t\t\t%s\n", platformVersion);
            cl_device_id devicesArray[] = platform.getAllDevicesIDs();
            clGetDeviceIDs(platform.getId(), CL_DEVICE_TYPE_ALL, numDevices, devicesArray, null);
            return devicesArray;
        }).forEachOrdered(devicesArray -> {
